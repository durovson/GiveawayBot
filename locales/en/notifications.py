TEXTS = {
    "notif_mgmt_title": (
        "┏┅⋐[ ◍ _◍ ]っ┅<tg-emoji emoji-id=\"5260325873688518261\">📢</tg-emoji>┅ / <b>Notifications</b> /\n"
        "┋\n"
        "┣ Manage your periodic advertisements.\n"
        "┋\n"
    ...
    "enter_buttons": (
        ...
        "┋\n"
        "┣ Send button labels and links.\n"
        "┣ Format: Text - https://link.com\n"
        "┋\n"
    ...
    "edit_buttons_btn": "Edit Buttons",
    "edit_interval_btn": "Edit Interval",
    "edit_chat_btn": "Edit Chat",
    "toggle_status_btn": "Status: {status}",
    "save_btn": "Save",
    "active": "Active",
    "paused": "Paused",
    "save_success": (
