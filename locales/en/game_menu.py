TEXTS = {
    ...
    "holders_chat_already_member": "You are already a member of the holders chat.",
    ...
    "referral_menu_title": (
        ...
        "┋\n"
        "┣ Press Share and choose a friend — the link and text will be inserted automatically.\n"
        "┋\n"
        "┗┅┅┅/ <b>Select an option</b> /"
    ),
