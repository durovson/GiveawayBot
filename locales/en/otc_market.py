TEXTS = {
    ...
    "otc_make_offer_btn": "MAKE OFFER", "otc_profile_btn": "PROFILE",
    "otc_publish_error": "❌ Could not create the OTC listing.",
    "otc_offer_unavailable": "❌ This listing or offer is no longer available.",
