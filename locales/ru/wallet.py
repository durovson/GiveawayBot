TEXTS = {
    "wallet_connected": (
        "┏┅<tg-emoji emoji-id=\"5258204546391351475\">💰</tg-emoji>┅ / <b>Кошелек подключен</b> /\n"
        "┋\n"
        "┣ <code>{address}</code>\n"
        "┋\n"
        "┗┅┅┅/ <b>Вы можете отключить этот кошелек и привязать новый, если необходимо</b> /"
    ),
    "wallet_connect": (
        "┏┅<tg-emoji emoji-id=\"5258204546391351475\">💰</tg-emoji> <b>Подключить кошелек</b> /\n"
        "┋\n"
        "┣ Подключите свой TON-кошелек, чтобы получить доступ к функциям для холдеров и розыгрышам.\n"
        "┋\n"
